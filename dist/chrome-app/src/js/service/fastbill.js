...
var FastBill = (function() {
  function FastBill($q, $rootScope, Storage, $log) {
    "use strict";
    this.client = client;
    this.$q = $q;
      ...
      try {
        this.storage.get('_credentials', function(credentials) {
          ...
          if (credentials) {
            ...
            self.login(credentials.username, credentials.apiKey).then(function() {
...
var $__default = ['$q', '$rootScope', 'Storage', '$log', function($q, $rootScope, Storage, $log) {
...
//# sourceMappingURL=../../js/service/fastbill.js.map